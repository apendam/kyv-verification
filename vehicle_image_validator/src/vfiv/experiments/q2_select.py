...
(``front_image/vrn_check.py``) is unaffected and always uses ``"rekognition"``.
...
from vfiv.front_image.vrn_check import classify_plate as _classify_plate_rekognition
