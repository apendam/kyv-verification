    ...
    "properties": {
        ...
        "is_altered_or_ai_generated": {
            ...
            "description": (
                ...
                "a screenshot, or a re-photographed printed photo -- including any "
                "of these specific tells: a visible watermark, logo, or signature "
                "mark typical of an AI image generator anywhere in the frame (a "
                "small corner mark, a semi-transparent overlay, a repeating tiled "
                "pattern, or text like 'AI' / 'Generated by...'); or a sticker or "
                "tag on the windshield (e.g. a FASTag) that looks pasted into the "
                "photo rather than physically stuck to the glass -- noticeably "
                "sharper focus, higher resolution, or more saturated colors than "
                "the rest of the vehicle, inconsistent lighting or shadow, or "
                "edges that don't sit naturally on the glass."
            ),
        },
        "confidence": {
            "type": "number",
...
PLATE_READ_SCHEMA: dict = {
    ...
    "properties": {
        ...
        "plate_looks_physically_genuine": {
            "type": "boolean",
            "description": (
                "False only if the plate itself shows a specific, describable sign "
                "of being digitally altered or composited rather than a real "
                "manufactured plate -- e.g. text that looks pasted on top of the "
                "plate surface rather than part of it, a font or character spacing "
                "inconsistent with a stamped/embossed/painted plate, a character "
                "layout that doesn't match the plate's own visible proportions or "
                "mounting slot (e.g. a single flattened line where the slot/frame "
                "implies two), lighting or reflection on the plate that doesn't "
                "match the rest of the vehicle, or a missing element the plate's "
                "evident format should have (e.g. the IND hologram mark on a "
                "high-security plate). True unless you can point to one of these "
                "-- never false from a hunch, low image quality, or normal wear. "
                "True whenever plate_visible is false (nothing to assess)."
            ),
        },
    },
