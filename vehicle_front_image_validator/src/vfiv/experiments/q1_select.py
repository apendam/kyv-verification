...
(``validators/front_image.py``) is unaffected and always uses ``"real_cv"``.
...
from vfiv.validators.front_image import classify_front_image as _classify_front_image_real_cv
